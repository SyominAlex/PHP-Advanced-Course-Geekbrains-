...
{
    // Чтобы каждый раз не указывать пользователя, введем свойство - экземпляр какого класса мы отдаем при Fetch
    protected $nestedClass = User::class;

    public function getByLoginPass($login, $pass)
    {
        //  u - это алиас для таблицы user в этом запросе, чтобы каждый раз не писать имя таблицы целиком
